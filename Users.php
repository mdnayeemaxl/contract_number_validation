        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo $actType;?> Dashboard</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        $sql= "SELECT * FROM fileinformation WHERE usersId='$userid'";
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>          
                                                <?php 
                                                    $toralUploaded=$row["totalUploaded"];
                                                    echo $toralUploaded;
                                                ?>                               
                                            </td>
                                            <td>          
                                            ...
                                            <td><a href="groupWiseView.php?name=<?php echo $fileName;?>"><span class="btn btn-primary">Groups</span></a></td>
